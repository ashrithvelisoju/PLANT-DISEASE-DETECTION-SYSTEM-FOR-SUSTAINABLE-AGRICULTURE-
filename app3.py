...
# Add this to your TEXT_CONTENT dictionary
TEXT_CONTENT.update({
    "farm_mapping": "FARM MAPPING ANALYSIS",
    "farm_mapping_title": "Farm Crop Mapping Analysis",
    "farm_map_upload": "Upload Multiple Farm Images",
    "farm_dimensions": "Farm Dimensions",
    "farm_width": "Width (meters)",
    "farm_height": "Height (meters)",
    "grid_size": "Grid Size",
    "rows": "Rows",
    "columns": "Columns",
    "upload_images": "Upload Images for Grid Locations",
    "process_farm": "Process Farm Images",
    "farm_analysis": "Farm-wide Analysis",
    "disease_hotspots": "Disease Hotspots",
    "severity_map": "Severity Map",
    "download_farm_report": "Download Farm Analysis Report",
